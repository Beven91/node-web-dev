...
const {DynamicViewProjectDev} = require('node-web-dev');
...
dev.on('dataWrap', (apiData) => {
    return Object.assign(commonData, apiData);
});

// dev.on('match', (route, url, req, res) => {
//     if (route) {
//         switch (route.dir) {
//             case 'websites':
//                 route.viewsDir = path.join(___dirname, 'projects/websites');
//                 break;
//             default:
//                 break;
//         }
